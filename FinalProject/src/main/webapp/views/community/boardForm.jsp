...
<div class="main-content">
  <div class="admin-container">
    ...
    <div class="admin-header">
      <h1>안녕하세요, ${sessionScope.authInfo.userId} 관리자님! 👋</h1>
      <p>새로운 커뮤니티 게시판을 생성해보세요</p>
    </div>

    <!-- 뒤로가기 버튼 -->
    <a href="/admin/communityAdmin?empNum=${sessionScope.authInfo.userNum}" class="back-button">
      ← 토론장 관리로 돌아가기
    </a>
      ...
      <form action="/boardWrite" method="post">
        ...
        <div class="form-group">
          ...
          <input 
            ...
            name="boardTitle" 
            class="form-input"
            placeholder="예: 주식 토론방, 투자 정보 공유방 등..."
            required 
            maxlength="50"
          />
          <div class="help-text">
            💡 게시판 이름은 최대 50자까지 입력 가능합니다
          </div>
        </div>
