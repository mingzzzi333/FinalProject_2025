    ...
    <table class="inquiry-table">
        <thead>
            <tr>
                ...
                <th style="width: 47%;">문의 내용 및 답변</th>
            </tr>
        </thead>
        <tbody>
            <c:forEach var="i" items="${inquiries}" varStatus="status">
                <tr>
                    ...
                    <td style="font-weight: 600;">${i.inquiryTitle}</td>
                    <td style="text-align: center;">
                        <span class="${i.inquiryStatus == '답변완료' ? 'status-completed' : 'status-pending'}">
                            ${i.inquiryStatus}
                        </span>
                    </td>
                    <td style="text-align: center;">
                    ...
                    <td>
                        <div class="inquiry-content">
                            <div class="question">
                                <strong>문의 내용:</strong> ${i.inquiryContent}
                            </div>
                            <c:if test="${not empty i.answerContent}">
                                <div class="answer">
                                    <strong>답변:</strong> ${i.answerContent}
                                </div>
                            </c:if>
                        </div>
                    </td>
